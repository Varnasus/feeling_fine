...
//        littleItaly = findViewById(R.id.little_italy);
//        littleItaly.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                Intent intent = new Intent(MainActivity.this, LittleItaly.class);
